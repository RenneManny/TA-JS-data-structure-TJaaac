...
// console.log(movies[movies.length].title);
...
console.log(movies[0].genres.concat.length-1);
...
for (let gene in movies[0].genres) {
  console.log(gene);
}

// 19. Log all the genres of the second movie one by one
for (let gene in movies[1].genres) {
  console.log(gene);
}
...
for (let movie of movies.year===2018) {
  console.log(movies.title);
}
